...
('alice_dev', 'pbkdf2$100000$salt123$abc123...', 'salt123', 'member', NOW() - INTERVAL '10 days'),
('bob_coder', 'pbkdf2$100000$salt456$def456...', 'salt456', 'member', NOW() - INTERVAL '7 days'),
('charlie_tech', 'pbkdf2$100000$salt789$ghi789...', 'salt789', 'member', NOW() - INTERVAL '5 days'),
('diana_design', 'pbkdf2$100000$salt012$jkl012...', 'salt012', 'guest', NOW() - INTERVAL '3 days'),
('admin', 'pbkdf2$100000$salt999$xyz999...', 'salt999', 'admin', NOW() - INTERVAL '1 day');

-- Insert sample posts
INSERT INTO posts (content, author_id, created_at) VALUES
(
